      ...
      <div className="flex space-x-2 flex-wrap">
        {filter.map((item, index) => (
          <div key={index} className='flex space-x-3 items-center justify-center bg-blue-100 shadow-sm text-xs px-3 py-2 rounded-full'>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" className='fill-black hover:fill-red-500' height="7px" width="7px" version="1.1" id="Capa_1" viewBox="0 0 460.775 460.775" xml:space="preserve" onClick={() => onChange(filter.filter((_, i) => i !== index))}>
