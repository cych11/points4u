    ...
    <div className='border rounded-lg p-6 shadow'>
      ...
      <div className='flex w-full justify-between'>
        ...
        <div className="hover:cursor-pointer hover:bg-blue-100 rounded-md p-1 items-center flex justify-center">
          <svg className="ml-[2px]" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" version="1.1" id="Capa_1" width="17px" height="17px" viewBox="0 0 494.936 494.936" xmlSpace="preserve" onClick={() => navigate(`/managers/manage-event/${event.id}`)}>
            <g>
              <g>
